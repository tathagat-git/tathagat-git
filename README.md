...
AI/ML engineer building systems end-to-end — model architectures, RAG pipelines, and the Python/Go backend tooling that ships them.
...
- **[MiniLLM](https://github.com/tathagat-git/MiniLLM)** — Transformer-based language model built from scratch: architecture, training, fine-tuning.
...
- Portfolio: [tathagat-git.github.io](https://tathagat-git.github.io/)
...
---
*Currently deep in LLM internals and agentic systems — open to AI/ML collaborations.*
